...
(arrDeclaration,
	[[ N optionalCHANGEMODE, N typedArr ]]),
(optionalCHANGEMODE,
	[[],
	 [T CHANGEMODE]]),
(optionalFLOWMODE,
...
(typedArr,
	[[T LSBRACKET, N rangeVal, T IDENT, T RSBRACKET, N typedIdent]]),
(rangeVal,
	[[N expression, T COLON, N expression]]),
(typeDeclaration,
	[[T TYPE],
	 [T IDENT]]),
(functionDeclaration,
...
(factor,
    [[T LITERAL],
	 ...
	 [T LSBRACKET, N expression, T RSBRACKET, T IDENT]]),
(optionalIdent,
	[[],
	 [T INIT],
	 [N expressionList]]),
